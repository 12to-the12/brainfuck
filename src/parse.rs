...
pub fn parse(program : String, slow: bool) {
    ...
    loop {
        ...
        println!("\nopen_stack:{:?}\nclose_stack:{:?}\n{program_pointer}",&open_stack,&close_stack);
